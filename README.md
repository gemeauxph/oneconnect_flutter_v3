...
void initState() {
    ...
    openvpn.initialize(
        groupIdentifier: "GROUP_IDENTIFIER", ///Example 'group.com.oneconnect.vpn'
        providerBundleIdentifier: "NETWORK_EXTENSION_IDENTIFIER", ///Example 'top.oneconnect.openvpnFlutterExample.VPNExtension'
